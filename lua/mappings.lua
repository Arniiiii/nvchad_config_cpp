...
vim.keymap.set("n", "<leader>CG", ":CMakeGenerate <CR>", { desc = "CMake Configure and generate" })
vim.keymap.set("n", "<leader>CB", ":CMakeBuild <CR>", { desc = "CMake Build" })
vim.keymap.set("n", "<leader>CR", ":CMakeRun <CR>", { desc = "CMake Run" })
vim.keymap.set("n", "<leader>CK", ":CMakeSelectKit <CR>", { desc = "CMake Select kit" })
vim.keymap.set("n", "<leader>CS", ":CMakeSettings <CR>", { desc = "CMake Project settings" })
...
vim.keymap.set("n", "<leader>Coe", ":CMakeOpenExecutor <CR>", { desc = "CMake Open executor" })
vim.keymap.set("n", "<leader>Cor", ":CMakeOpenRunner <CR>", { desc = "CMake Open runner" })
vim.keymap.set("n", "<leader>Cse", ":CMakeStopExecutor <CR>", { desc = "CMake Stop current cmake executor's process" })
vim.keymap.set("n", "<leader>Csr", ":CMakeStopRunner <CR>", { desc = "CMake Stop current cmake runner's process" })
vim.keymap.set("n", "<leader>Cc", ":CMakeClean <CR>", { desc = "CMake Clean" })
vim.keymap.set("n", "<leader>Cqb", ":CMakeQuickBuild <CR>", { desc = "CMake Quick build" })
vim.keymap.set("n", "<leader>Cqr", ":CMakeQuickRun <CR>", { desc = "CMake Quick run" })
...
vim.keymap.set("n", "<leader>Csp", ":CMakeSelectBuildPreset <CR>", { desc = "CMake Select build preset" })
vim.keymap.set("n", "<leader>Cst", ":CMakeSelectBuildTarget <CR>", { desc = "CMake Select build target" })
vim.keymap.set("n", "<leader>CsT", ":CMakeSelectBuildType <CR>", { desc = "CMake Select build variant" })
vim.keymap.set("n", "<leader>Csc", ":CMakeSelectConfigurePreset <CR>", { desc = "CMake Select configure preset" })
vim.keymap.set("n", "<leader>Csl", ":CMakeSelectLaunchTarget <CR>", { desc = "CMake Select launch target" })
vim.keymap.set("n", "<leader>Ctf", ":CMakeShowTargetFiles <CR>", { desc = "CMake Show target file" })
vim.keymap.set("n", "<leader>Cts", ":CMakeTargetSettings <CR>", { desc = "CMake Target settings" })
vim.keymap.set("n", "<leader>Csb", ":CMakeSelectBuildDir <CR>", { desc = "CMake Select build dir" })
vim.keymap.set("n", "<leader>Csw", ":CMakeSelectCwd <CR>", { desc = "CMake Select cwd" })
...
vim.api.nvim_set_keymap("n", "<M-j>", "<cmd>cnext<cr>zz", { desc = "Quickfix next" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<M-k>", "<cmd>cprev<cr>zz", { desc = "Quickfix next" , noremap = true, silent = true })
...
vim.api.nvim_set_keymap("n", "<M-.>", "<cmd>lnext<cr>zz", { desc = "Location_list next" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<M-,>", "<cmd>lprev<cr>zz", { desc = "Location_list next" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>.", "<cmd>lnext<cr>", { desc = "Location_list next without zz" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>,", "<cmd>lprev<cr>", { desc = "Location_list next without zz" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>lo", "<cmd>lopen<cr>", { desc = "Location_list open" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>lc", "<cmd>lclose<cr>", { desc = "Location_list close" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>lp", "<cmd>lolder<cr>", { desc = "Location_list previous list (lolder)" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>ln", "<cmd>lnewer<cr>", { desc = "Location_list next list (lnewer)" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>lg", "<cmd>lfirst<cr>", { desc = "Location_list first in list (lfirst)" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>lG", "<cmd>llast<cr>", { desc = "Location last in list (llast)" , noremap = true, silent = true })
