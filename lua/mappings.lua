...
vim.api.nvim_set_keymap("n", "<leader>,", "<cmd>lnext<cr>", { desc = "Location list next without zz" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>.", "<cmd>lprev<cr>", { desc = "Location list next without zz" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>lo", "<cmd>lopen<cr>", { desc = "Location list open" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>lc", "<cmd>lclose<cr>", { desc = "Location list close" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>lp", "<cmd>lolder<cr>", { desc = "Location list previous list (colder)" , noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>ln", "<cmd>lnewer<cr>", { desc = "Location list next list (cnewer)" , noremap = true, silent = true })
